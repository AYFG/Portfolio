...
export default function Hero() {
  return (
    <section
      className="border-b border-gray-200  relative py-24 md:py-32 lg:py-40 px-6 overflow-hidden"
      style={{
    ...
    >
      <div className="absolute inset-0 bg-white/0 backdrop-blur-[0px]"></div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            배포까지의 과정을 경험했습니다. 앞으로도 새로운 기술에 대한 호기심을 멈추지 않고
            행동으로 옮기는 개발자가 되겠습니다.
          </p>
        </div>
      </div>
