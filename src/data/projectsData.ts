...
`,
      },
      {
        ...
        detail: `
- Rive 디자인 툴을 사용하여 고양이 캐릭터, 눈깜빡임, 사냥 애니메이션을 제작했습니다.
`,
      },
...
- JsonWebToken을 사용해 유저 인증을 적용했습니다.
`,
      },
      {
        title: "라즈베리파이를 사용하여 백엔드 서버 운영",
        detail: `
- lets encrypt에서 인증서를 발급받아 nginx로 80포트로 들어온 요청을 443포트로 리다이렉트하여 https를 적용했습니다.
...
- setTimeout을 사용해 설정한 시간이 되었을 떄 알림이 울리도록 하여도 시간에 맞춰 알림이 울리지 않았습니다.
...
- 그리고 유저에게 받아야 하는 권한이 추가되었을 때 변경사항에 적용하지 않으면 앱 업데이트 검토에서 거부되는 것을 알게되었고 변경사항을 적용하여 무사히 업데이트를 통과했습니다.
      `,
      },
      {
        title: "API 통신 속도 저하",
...
`,
    mainFeatures: [
      ...
      {
        title: "상품 구매",
        detail: `- PortOne SDK를 사용하여 카카오페이, 토스페이등 결제를 연동했습니다.`,
      },
      {
        title: "상품 검색",
...
이 문제를 개선하기 위해 Promise.all을 사용해 병렬 요청으로 변경하여 성능을 향상 시켰습니다.
...
- 이 성능 개선으로 초기 콘텐츠 다운로드를 기존 2.45초에서 69.92ms로 97%로 성능을 향상시켰고 lighthoust 성능 점수를 92점에서 97점으로 향상시켰습니다.
    ...
    mainFeatures: [
      {
        ...
        detail: "![스플래시 페이지 CSS 애니메이션](/moamoa/feature/splashAnimation.gif)",
      },
      {
        title: "축제 체험 리스트",
        detail: `
![스플래시 페이지 CSS 애니메이션](/moamoa/feature/infiniteScroll.gif)
- 로딩동안 스켈레톤 이미지 삽입, IntersectionObserver를
`,
      },
      {
        title: "유저 검색 페이지",
        detail: `
![스플래시 페이지 CSS 애니메이션](/moamoa/feature/search.gif)
- 스켈레톤 이미지
`,
      },
      {
        title: "반응형 웹 디자인",
        detail: "주요 기능에 대한 상세 설명입니다. (예시)",
      },
    ],
    troubleShooting: [
